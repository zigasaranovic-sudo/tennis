    ...
    <div className="-mx-4 sm:-mx-6 lg:-mx-8">
      ...
      <div className="bg-slate-900 border-b border-slate-800 px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-3 bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 focus-within:border-green-500/50 transition-colors">
            ...
            />
            {search && (
              <button onClick={() => setSearch("")} className="text-slate-500 hover:text-slate-300 transition-colors text-lg leading-none">×</button>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {[...Array(8)].map((_, i) => (
                <div key={i} className="rounded-2xl overflow-hidden animate-pulse bg-slate-800 border border-slate-700">
            ...
            <div className="text-center py-20">
              ...
              {search && (
                <button onClick={() => setSearch("")} className="mt-4 px-4 py-2 text-sm text-green-400 hover:text-green-300 font-semibold">
              ...
              {filtered.map((venue) => {
                ...
                return (
                  <Link
                    ...
                    className="group rounded-2xl overflow-hidden bg-slate-800 border border-slate-700 hover:border-green-500/50 hover:shadow-xl hover:shadow-green-500/5 transition-all"
                  >
                    {/* Venue photo */}
